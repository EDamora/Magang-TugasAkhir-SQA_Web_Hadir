...
public class DivisiTest {
    ...
    private static WebLoginPage loginPage = new WebLoginPage();
    ...
    @Given("Masuk menu login")
    public void masuk_menu_login(){
        driver.get(Constants.URL);
        loginPage.loginUser("admin@hadir.com", "admin@hadir");
        loginPage.setBtnLogin();
    }
    @When("Masuk management sidebar")
    public void masuk_management_sidebar(){
        divisiPage.clickManagementSideBar();
    }

    @Then("Halaman ke divisi menu")
    public void halaman_ke_divisi_menu(){
        divisiPage.clickDivisiSideBar();
    }
    ...
    public void masukan_nama_divisi_baru(){
        globalElementPage.setNewItemName("JC-SQA 19");
    ...
    public void kembali_ke_daftar_divisi_divisi_baru_batal_di_tambahkan(){
        globalElementPage.setSearchName("JC-SQA 19");
    ...
    public void muncul_pop_up_gagal_menambahkan_divisi(){
    ...
    public void divisi_baru_berhasil_ditambahkan(){
        ...
        globalElementPage.clickSearchSubmitButton();
        DriverSingleton.delay(1);
        Assert.assertEquals(globalElementPage.getTextFromTopmostRowFirstColumn(), "JC-SQA 19");
    ...
    public void divisi_baru_gagal_ditambahkan_divisi_sudah_tersedia(){
        ...
        globalElementPage.clickSearchSubmitButton();
        DriverSingleton.delay(1);
        Assert.assertEquals(globalElementPage.getCountOfTextInFirstColumn("JC-SQA 19"), 1);
    ...
    public void masukan_nama_divisi_yang_tidak_ada_pada_list(){
        DriverSingleton.delay(1);
        globalElementPage.setSearchName("Programmer");
...
//  #8 Scenario: Cari divisi dengan nama "JC-SQA 19" (Done)

    //  #9 Scenario: Batal edit divisi dengan nama "JC-SQA 19" menjadi "JC-SQA Batch 19"
    ...
    public void rubah_nama_divisi_menjadi_nama_divis_baru(){
        globalElementPage.setNewItemName("JC-SQA Batch 19");
    ...
    public void nama_divisi_masih_nama_divisi_lama(){
        ...
        Assert.assertEquals(globalElementPage.getCountOfTextInFirstColumn("JC-SQA 19"), 2);
        extentTest.log(LogStatus.PASS, "Nama divisi masih nama divisi lama");
    }

    //  #10 Scenario: Edit divisi dengan nama "JC-SQA 19" menjadi "JC-SQA Batch 19"
    @And("Klik \"Simpan\"")
    ...
    public void nama_divisi_lama_ganti_menjadi_nama_divisi_baru(){
        ...
        globalElementPage.clickResetSearchButton();
        DriverSingleton.delay(1);
        globalElementPage.setSearchName("JC-SQA Batch 19");
        globalElementPage.clickSearchSubmitButton();
        DriverSingleton.delay(1);

        Assert.assertEquals(globalElementPage.getCountOfTextInFirstColumn("JC-SQA Batch 19"), 1);
    ...
    public void divisi_baru_masih_ada_pada_daftar_divisi(){
        Assert.assertEquals(globalElementPage.getCountOfTextInFirstColumn("JC-SQA Batch 19"), 2);
