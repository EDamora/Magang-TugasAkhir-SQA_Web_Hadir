...
public class IzinPulangCepatTest {
    ...
    public void pengguna_memasukkan_tanggal_yang_valid() {
        izinPulangCepat.setTanggal("Dec 01, 2024", "Dec 28, 2024");
    ...
    public void pengguna_mengisi_nama_valid_dan_tanggal_valid() {
        izinPulangCepat.setNama("Damoraaa");
        izinPulangCepat.setTanggal("Dec 25, 2024", "Dec 30, 2024");
    ...
    public void sistemmenampilkandataizinpulangcepatberdasarkannamadantanggalyangsesuai() {
        ...
        String tableRowText = izinPulangCepat.getTableRowText(1);
        System.out.println(tableRowText);
        Assert.assertTrue(tableRowText.contains("Damoraaa"), "Table row should contain the name 'Damoraaa'");
    ...
    public void pengguna_mengisi_nama_tidak_valid() {
        izinPulangCepat.setNama("D@moraaa");
        izinPulangCepat.clickSearch();
        Utils.delay(3);
    ...
    public void sistemMenampilkanNamaTidakValid() {
        String tableRowText = izinPulangCepat.getTableRowText(1);
        System.out.println(tableRowText);
        Assert.assertTrue(tableRowText == null || !tableRowText.contains("D@moraaa"), "Table row should not contain the name 'D@moraaa'");
        Utils.delay(3);
    ...
    public void penggunatidakmengisistartdatetetapimengisienddate() {
        izinPulangCepat.setTanggal("", "Des 27, 2024");
        izinPulangCepat.clickSearch();
        Utils.delay(5);
    ...
    public void penggunamemilihfilterdepartemen() {
        ...
        Utils.delay(5);
        extentTest.log(LogStatus.PASS, "pengguna memilih filter departemen \"IT Programmer\"");
    }
    ...
    @When("pengguna mengklik tombol X pada filter nama \"IT Programmer\"")
    public void pengguna_xpadafilternama() {
        izinPulangCepat.setBtnX();
        extentTest.log(LogStatus.PASS, "pengguna mengklik tombol X pada filter nama \"IT Programmer\"");
    }

    @Then("filter nama \"IT Programmer\" dihapus dan data ditampilkan tanpa filter nama pada izin pulang cepat")
