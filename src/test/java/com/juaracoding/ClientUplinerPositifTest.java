...
public class ClientUplinerPositifTest {
    ...
    public void klik_pada_kolom_search() {
        ...
        clientUplinerPage.getSearch("Damora");
    ...
    public void menampilkan_data_sesuai_diinput() {
        Utils.delay(2);
        Assert.assertEquals(clientUplinerPage.getValueSearch(),"Damora");
...
//    }
    ...
    public void klik_button_daftar() {
        Utils.waitAndClick(driver, clientUplinerPage.getBtnDaftarUpliner());
...
//        driver.navigate().back();
    ...
    public void user_berhasil_dihapus(){
        Utils.delay(2);
        Assert.assertEquals(absenPointPage.getTxtValDelete(),"");
