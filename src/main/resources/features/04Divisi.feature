...
#Tambah aja
  ...
  Scenario: Login Admin Terlebih dahulu
  ...
  #8
  Scenario: Cari divisi dengan nama "JC-SQA Batch 19"
    Given Masuk menu "Divisi"
    When Masukan nama divisi pada kolom pencarian
    And Klik tombol "Search"
  ...
  #9
  Scenario: Batal edit divisi dengan nama "JC-SQA Batch 19" menjadi "JC-SQA Batch 19"
  ...
  #10
  Scenario: Edit divisi dengan nama "JC-SQA 19" menjadi "JC-SQA Batch 19"
    Given Cari divisi pada kolom pencarian
    When Klik icon 3 baris pada sisi kanan baris divisi yang dicari
    And Klik "Edit"
    And Rubah "Nama Divisi" menjadi nama divisi baru
