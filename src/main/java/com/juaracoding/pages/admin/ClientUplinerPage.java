...
//    @FindBy(xpath = "//*[@id=\"mui-component-select-job_departement_id\"]")
    ...
    @FindBy(xpath = "//h6[normalize-space()='Damora']")
...
//        js.executeScript("document.querySelector('#fullname').value = ''");
//        fieldNamaKaryawan.clear();
        fieldNamaKaryawan.sendKeys(Keys.CONTROL + "a");
        fieldNamaKaryawan.sendKeys(Keys.DELETE);
    }
...
//        fieldEmail.clear();
    ...
    public void clearEmailBca(){
        fieldEmailBca.sendKeys(Keys.CONTROL + "a");
        fieldEmailBca.sendKeys(Keys.DELETE);
//        fieldEmailBca.clear();
    }
...
//    }
    ...
    public void clearUsername(){
        fieldUsername.sendKeys(Keys.CONTROL + "a");
        fieldUsername.sendKeys(Keys.DELETE);
//        fieldUsername.clear();
    }
...
//        btnSvg.click();
    ...
    public void getFoto(){
        Foto.sendKeys("C:\\MyTools\\karyawan.png");
    }
